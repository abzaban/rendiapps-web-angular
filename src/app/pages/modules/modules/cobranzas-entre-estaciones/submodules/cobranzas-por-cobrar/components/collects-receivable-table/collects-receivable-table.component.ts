...
@Component({
  selector: 'collects-receivable-table-component',
  templateUrl: './collects-receivable-table.component.html'
})
export class CollectsReceivableTableComponent implements AfterViewInit, AfterContentInit {
  ...
  delete(collectId: string) {
    this.collectAction.emit({ action: 'delete', entityId: collectId });
  }
}
